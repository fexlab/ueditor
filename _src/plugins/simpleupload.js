...
UE.plugin.register("simpleupload", function() {
    ...
    function initUploadBtn() {
      ...
      domUtils.on(btnIframe, "load", function() {
        ...
        wrapper.innerHTML =
          '<form id="edui_form_' + timestrap + '" target="edui_iframe_' + timestrap + '" method="POST" enctype="multipart/form-data" action="' + me.getOpt("serverUrl") + '" ' + 'style="' + btnStyle + '">' +
        ...
        domUtils.on(input, "change", function() {
          ...
          var allowFiles = me.getOpt('imageAllowFiles') || [".png", ".jpg", ".jpeg", ".gif", ".bmp"];
          ...
          if (
            !fileext || (allowFiles && (allowFiles.join("") + ".").indexOf(fileext.toLowerCase() + ".") == -1)
          ) {

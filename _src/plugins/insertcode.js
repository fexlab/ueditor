...
UE.plugins['insertcode'] = function() {
    ...
    me.commands['insertcode'] = {
        execCommand : function(cmd,lang){
            ...
            if(pre){
                pre.className = 'code-snippet code-snippet_nowrap code-snippet__'+lang+' brush:'+lang+';toolbar:false;';
            }else{
                var code = '';
                if(rng.collapsed){
                ...
                me.execCommand('inserthtml','<pre id="coder" class="code-snippet code-snippet_nowrap code-snippet__'+lang+' brush:'+lang+';toolbar:false"><code>'+code+'</code></pre>',true);

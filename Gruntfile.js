...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            css: {
                ...
                dest: disDir + 'themes/lemon/css/ueditor.css'
            }
        },
        cssmin: {
            options: {
            ...
            files: {
                expand: true,
                cwd: disDir + 'themes/lemon/css/',
                src: ['*.css', '!*.min.css'],
                dest: disDir + 'themes/lemon/css/',
                ext: '.min.css'
            }
        },
        uglify: {
    ...
    function updateServiceFile() {
        var filename = "ueditor.service.js",
            file = grunt.file.read(filename);
        ...
        //写入到dist
        if (grunt.file.write(disDir + filename, file)) {
            grunt.log.writeln("service file update success");
        } else {
            grunt.log.warn("service file update error");
        }
    }
